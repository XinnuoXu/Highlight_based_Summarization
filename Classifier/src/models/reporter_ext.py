...
class Statistics(object):
    ...
    * elapsed time
    ...
    def __init__(self, loss=0, p_loss=0, n_loss=0, hl_loss=0, topk_loss=0, n_docs=0, n_correct=0):
        self.loss = loss
    ...
    def update(self, stat, update_n_src_words=False):
        ...
        """
        self.topk_loss += stat.topk_loss
        self.loss += stat.loss
        self.p_loss += stat.p_loss
        self.n_loss += stat.n_loss
        self.hl_loss += stat.hl_loss
    ...
    def hl(self):
        ...
        if (self.n_docs == 0):
            return 0
        return self.hl_loss / self.n_docs

    def p_score(self):
        """ compute cross entropy """
        if (self.n_docs == 0):
            return 0
        return self.p_loss / self.n_docs

    def topk(self):
        """ compute cross entropy """
        if (self.n_docs == 0):
            return 0
        return self.topk_loss / self.n_docs

    def n_score(self):
        """ compute cross entropy """
        if (self.n_docs == 0):
            return 0
        return self.n_loss / self.n_docs
    ...
    def output(self, step, num_steps, learning_rate, start):
        ...
        logger.info(
            ("Step %s; xent: %4.4f; hl: %4.4f; p_score: %4.4f; n_score: %4.4f; topk: %4.4f; "
